...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "grid-glow":
          "radial-gradient(circle at 20% 0%, rgba(139,92,246,0.18), transparent 45%), radial-gradient(circle at 80% 10%, rgba(34,211,238,0.16), transparent 50%), radial-gradient(circle at 50% 100%, rgba(236,72,153,0.14), transparent 55%)",
        "noise":
